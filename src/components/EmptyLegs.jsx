      ...
      <div className="max-w-container mx-auto px-5 sm:px-8">
        <Reveal className="mb-12 md:mb-16 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          ...
          <p className="text-sm text-gray-500 leading-relaxed max-w-sm">
            Rutas ya programadas con asientos disponibles a una fracción del costo regular.
            Los ejemplos de abajo ilustran el formato: la publicación de empty legs en vivo
            está en desarrollo, y cada tramo se confirma con el concierge.
          </p>
        </Reveal>
        ...
        >
          {EMPTY_LEGS.map((leg) => (
            <motion.div
              key={leg.id}
              variants={fadeUp}
              className="card-clean card-clean-hover p-5 md:p-6 flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-8 group"
            >
              {/* Route */}
              ...
              {/* Price + CTA */}
              <div className="flex items-center justify-between lg:justify-end gap-5 lg:pl-6 lg:border-l border-gray-200/70">
                <div className="flex flex-col">
                ...
                <a
                  href={buildWhatsAppUrl(formatEmptyLegMessage(leg))}
                  target="_blank"
